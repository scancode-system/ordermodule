...
<div class="list-group list-group-accent">
    ...
    @loader(['loader_path' => 'aside.report.items'])
</div>
<div class="list-group list-group-accent">
...
<div class="list-group list-group-accent">
    ...
    <a href="{{ route('reports.sallers') }}" class="list-group-item list-group-item-accent-dark list-group-item-divider list-group-item-action">Básico</a>
</div>