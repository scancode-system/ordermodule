<div class="col-md-{{ $widget->columns }}">
	<div class="card text-white bg-info">
		<div class="card-body pb-0">
			...
			<div>Número de pedidos do dia</div>
		</div>
		<div class="chart-wrapper mt-3 mx-3" style="height:70px;">
			<canvas class="chart" id="mini_chart_order_{{ $widget->id }}" height="70"></canvas>
		</div>
	</div>
</div>
...
<script>
	...
	var mini_chart_order_{{ $widget->id }}  = new Chart($('#mini_chart_order_{{ $widget->id }}'), {
		type: 'line',
		data: {
